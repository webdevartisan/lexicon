...
?>
            ...
            <div class="lx-field">
                <label class="lx-field-label" for="username_display"><?= e($t('account.preferences.username')) ?></label>
                <input class="lx-field-input" id="username_display" type="text" value="<?= e($username) ?>" disabled>
                <p class="lx-field-hint"><?= e($t('account.preferences.usernameDisabled')) ?></p>
            </div>

            <div class="lx-field<?= !empty($fieldErrors['email']) ? ' lx-field-invalid' : '' ?>">
                <label class="lx-field-label" for="email"><?= e($t('account.preferences.email')) ?></label>
                <input class="lx-field-input" type="email" name="email" id="email"
                ...
                <p class="lx-field-hint" id="email_hint"><?= e($t('account.preferences.emailHelp')) ?></p>
                <?php foreach ($fieldErrors['email'] ?? [] as $message) { ?>
                <p class="lx-field-error" id="email_error"><?= e($message) ?></p>
                <?php } ?>
            </div>
            ...
            <div class="lx-field<?= !empty($fieldErrors['current_password']) ? ' lx-field-invalid' : '' ?>">
                ...
                <input class="lx-field-input" type="password" name="current_password" id="current_password"
                       autocomplete="current-password"
                       <?= !empty($fieldErrors['current_password']) ? 'aria-invalid="true" aria-describedby="cp_error"' : 'aria-describedby="cp_hint"' ?>>
                <p class="lx-field-hint" id="cp_hint"><?= e($t('account.preferences.currentPasswordHelp')) ?></p>
                <?php foreach ($fieldErrors['current_password'] ?? [] as $message) { ?>
                <p class="lx-field-error" id="cp_error"><?= e($message) ?></p>
                <?php } ?>
            </div>
            ...
            <div class="lx-grid-2">
                <div class="lx-field">
                    <label class="lx-field-label" for="display_name"><?= e($t('account.preferences.displayName')) ?></label>
                    <?php $dn = old('display_name') ?? ($user['display_name'] ?? 'username'); ?>
                    <select class="lx-field-input" name="display_name" id="display_name">
                ...
                <div class="lx-field">
                    <label class="lx-field-label" for="default_visibility"><?= e($t('account.preferences.defaultVisibility')) ?></label>
                    <?php $dv = old('default_visibility') ?? ($user['default_visibility'] ?? 'public'); ?>
                    <select class="lx-field-input" name="default_visibility" id="default_visibility">
            ...
            <div class="lx-grid-2">
                <div class="lx-field">
                    ...
                    <select class="lx-field-input" name="timezone" id="timezone">
