  ...
  <div class="error-content">
    ...
    {% if (empty($isDev)): %}
      ...
      <div class="error-message-card">
        ...
        <p class="error-message-text">Your session expired before the form was submitted, so we stopped it rather than risk acting on a stale request. Nothing was changed. Go back, reload the page, and submit again.</p>
      </div>
    {% else %}
