...
<style>
  ...
  .post-engagement .engage-btn[data-engage="like"].is-active { color: #c22a4a; }
  .post-engagement .engage-btn[data-engage="like"].is-active svg { fill: #c22a4a; }
  .post-engagement .engage-btn[data-engage="bookmark"].is-active { color: var(--ink); }
  .post-engagement .engage-btn[data-engage="bookmark"].is-active svg { fill: var(--ink); }
  .share-popover { position: absolute; bottom: calc(100% + 8px); left: 0; min-width: 210px; background: var(--bone); border: 1px solid var(--rule); border-radius: 10px; box-shadow: 0 8px 24px rgba(10,10,10,.12); padding: .4rem; z-index: 50; }
  ...
  .reply-form .btn-reply { margin-top: .5rem; padding: .45rem 1rem; border: 1px solid var(--rule-strong); background: var(--ink); color: var(--bone); font-family: var(--mono); font-size: var(--type-mono); letter-spacing: .1em; text-transform: uppercase; cursor: pointer; }
